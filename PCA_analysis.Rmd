...
```{r setup, include = TRUE, eval = TRUE,tidy.opts=list(width.cutoff=65)}
...
```{r libraries, eval=T, message=FALSE, include=TRUE}
# load packages
...
```{r, fig.asp=.65, fig.width=8, fig.align='default'}
...
```{r, fig.asp=.65, fig.width=10, fig.align='default'}
...
```{r, fig.height=8, fig.width=10, fig.align='default', tidy=TRUE, tidy.opts=list(width.cutoff=65)}
